...
public class MeteorSpawner : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            spawnNext = Time.time + 60f / spawnPerMinute; //hora actual mas el tiempo por minuto dividido la tasa de spawn
            ...
            Vector3 spawnPosition = new Vector3(random, 14f, 20.39f); //generar una posicion aleatoria en el eje x
